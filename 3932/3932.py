...
#         year = date.year
#         dest_path = "s3://staging-near-data-analytics/shashwat/ps-3932/footfall_gh8/50m/{}/".format(date)
...
# #########################
# # report 1
# df = spark.read.parquet('s3://staging-near-data-analytics/shashwat/ps-3932/footfall_gh8/50m/combined/*')
...
# final.coalesce(1).write.mode('append').csv("s3://staging-near-data-analytics/shashwat/ps-3932/reports/removed_multiple_profile_ids/report_1/", header = True)
...
# result.coalesce(1).write.mode('append').csv("s3://staging-near-data-analytics/shashwat/ps-3932/reports/removed_multiple_profile_ids/report_2/", header=True)
...
df.coalesce(1).write.mode('append').csv("s3://staging-near-data-analytics/shashwat/ps-3932/reports/removed_multiple_profile_ids/report_3/", header=True)
