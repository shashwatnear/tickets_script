...
#         year = date.year
#         dest_path = "s3://staging-near-data-analytics/shashwat/ps-3932/final/staypoints/footfall_gh8/50m/{}/".format(date)
...
# #########################
# report 1
# df = spark.read.parquet('s3://staging-near-data-analytics/shashwat/ps-3932/final/refined/footfall/combined/*')
...
# final.coalesce(1).write.mode('append').csv("s3://staging-near-data-analytics/shashwat/ps-3932/final/report/report_1/", header = True)
...
result.coalesce(1).write.mode('append').csv("s3://staging-near-data-analytics/shashwat/ps-3932/test1/report/report_2/", header=True)
...
# df.coalesce(1).write.mode('append').csv("s3://staging-near-data-analytics/shashwat/ps-3932/final/report/report_3/", header=True)
