...
attributed_footfall_in_campaign = spark.read.parquet('s3://staging-near-data-analytics/shashwat/ps-4010/attributed_footfall/*')
...
result.coalesce(1).write.option("header",True).mode('append').csv("s3://staging-near-data-analytics/shashwat/ps-4010/ids_seen_only_in_campaign/")
