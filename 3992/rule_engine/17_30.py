...
poi = spark.read.csv('s3://staging-near-data-analytics/shashwat/ps-3992/files/3992_17_30.csv', header = True)
...
for date in dates:
    ...
    ff_df.write.mode("append").parquet("s3://staging-near-data-analytics/shashwat/ps-3992/poi_footfall/ubermedia/17_30/{}/".format(date))