...
poi = spark.read.csv('s3://staging-near-data-analytics/shashwat/ps-3992/files/3992_16_14.csv', header = True)
...
for date in dates:
    ...
    ff_df.write.mode("append").parquet("s3://staging-near-data-analytics/shashwat/ps-3992/poi_footfall/ubermedia/16_14/{}/".format(date))