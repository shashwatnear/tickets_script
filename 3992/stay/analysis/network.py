...
total_ids.coalesce(1).write.option("header",True).mode('append').csv("s3://staging-near-data-analytics/shashwat/ps-3992/double_radius/reports/network/total/")
...
avg.coalesce(1).write.option("header",True).mode('append').csv("s3://staging-near-data-analytics/shashwat/ps-3992/double_radius/reports/network/avg/")

print("network wise freq 1")
freq1 = temp.filter(col('exposed_days') == 1).groupBy('network').agg(countDistinct('ifa')).orderBy('network')
freq1.coalesce(1).write.option("header",True).mode('append').csv("s3://staging-near-data-analytics/shashwat/ps-3992/double_radius/reports/network/freq1/")

print("network wise freq 2")
freq2 = temp.filter(col('exposed_days') == 2).groupBy('network').agg(countDistinct('ifa')).orderBy('network')
freq2.coalesce(1).write.option("header",True).mode('append').csv("s3://staging-near-data-analytics/shashwat/ps-3992/double_radius/reports/network/freq2/")
...
freq3.coalesce(1).write.option("header",True).mode('append').csv("s3://staging-near-data-analytics/shashwat/ps-3992/double_radius/reports/network/freq3/")
...
male.coalesce(1).write.option("header",True).mode('append').csv("s3://staging-near-data-analytics/shashwat/ps-3992/double_radius/reports/network/male/")
# ######################################################
...
female.coalesce(1).write.option("header",True).mode('append').csv("s3://staging-near-data-analytics/shashwat/ps-3992/double_radius/reports/network/female/")
# ######################################################
