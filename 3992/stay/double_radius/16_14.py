...
spark = SparkSession.builder.appName("3992_16th_to_14th").getOrCreate()
...
poi = spark.read.csv('s3://staging-near-data-analytics/shashwat/ps-3992/files/16-14.csv', header = True)
...
for date in dates:
    ...
    ff_df.write.mode("append").parquet("s3://staging-near-data-analytics/shashwat/ps-3992/double_radius/poi_footfall/stay/16_14/{}/".format(date))