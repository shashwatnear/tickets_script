...
poi = spark.read.csv('s3://staging-near-data-analytics/shashwat/ps-3992/files/21-30.csv', header = True)
...
for date in dates:
    ...
    ff_df.write.mode("append").parquet("s3://staging-near-data-analytics/shashwat/ps-3992/double_radius/poi_footfall/stay/21_30/{}/".format(date))