...
spark = SparkSession.builder.appName("3992_17th_to_30th").getOrCreate()
...
poi = spark.read.csv('s3://staging-near-data-analytics/shashwat/ps-3992/files/17-30.csv', header = True)
poi = poi.withColumn('radius', (col('radius') * 2))
...
for date in dates:
    ...
    ff_df.write.mode("append").parquet("s3://staging-near-data-analytics/shashwat/ps-3992/double_radius/poi_footfall/stay/17_30/{}/".format(date))