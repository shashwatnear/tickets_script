...
output_path = "s3://staging-near-data-analytics/shashwat/ps-3929/campaign_data/places_geohash/Oregon/"
...
poi = spark.read.parquet('s3://staging-near-data-analytics/shashwat/ps-3929/campaign_data/places_geohash/Oregon/*')
...
for date in dates:
    ...
    year = date.year
    dest_path = "s3://staging-near-data-analytics/shashwat/ps-3929/campaign/footfall/{}/".format(date)
