...
df1 = spark.read.csv('/Users/nlblr245/Downloads/2.csv', header = True)
...
df2 = spark.read.option("header", "true").option("delimiter", ";").csv('/Users/nlblr245/Downloads/azira_results_2.csv')
