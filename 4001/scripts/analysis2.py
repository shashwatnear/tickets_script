...
input_ip = spark.read.csv('s3://staging-near-data-analytics/shashwat/ps-4001/files/list2.csv', header = True)
...
df1 = spark.read.csv('s3://staging-near-data-analytics/shashwat/ps-4001/maxmind_data/2.csv', header = True)
...
df2 = spark.read.option("header", "true").option("delimiter", ";").csv('s3://staging-near-data-analytics/shashwat/ps-4001/de_data/azira_results_2.csv')
