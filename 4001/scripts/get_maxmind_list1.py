...
df = spark.read.csv("/Users/nlblr245/Desktop/ticket/4001/iplistsharedbyme/list1.csv", header = True)
...
df.coalesce(1).write.option("header", True).mode('append').csv("/Users/nlblr245/Desktop/tickets/4001/list1/")
