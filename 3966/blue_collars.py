...
spark = SparkSession.builder.appName("3966_industrial").getOrCreate()
...
df = spark.read.parquet('s3://staging-near-data-analytics/shashwat/ps-3966/footfall_gh8_with_geohash/50m/*/*')
...
df.coalesce(1).write.mode('append').csv('s3://staging-near-data-analytics/shashwat/ps-3966/phase_2/blue_collars/',header=True)
