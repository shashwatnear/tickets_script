...
df1 = spark.read.parquet('s3://staging-near-data-analytics/shashwat/ps-3966/reports/blue_collars/parquet/*')

df2 = spark.read.parquet('s3://staging-near-data-analytics/shashwat/ps-3966/reports/malaysian/parquet/*')
df2 = df2.withColumn('deviceID', sha_udf(col('ifa'))).drop('ifa')

df3 = spark.read.parquet('s3://staging-near-data-analytics/shashwat/ps-3966/reports/parents_at_kinder_pre/parquet/*')
df4 = spark.read.parquet('s3://staging-near-data-analytics/shashwat/ps-3966/reports/primary_school/parquet/*')
df5 = spark.read.parquet('s3://staging-near-data-analytics/shashwat/ps-3966/reports/expats/parquet/*')
# #####
...
result1.coalesce(1).write.mode('append').csv('s3://staging-near-data-analytics/shashwat/ps-3966/celia/blue_collars/', header = True)
result2.coalesce(1).write.mode('append').csv('s3://staging-near-data-analytics/shashwat/ps-3966/celia/malaysian/', header = True)
...
result5.coalesce(1).write.mode('append').csv('s3://staging-near-data-analytics/shashwat/ps-3966/celia/expats/', header = True)
