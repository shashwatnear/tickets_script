...
spark = SparkSession.builder.appName("3966_primary_school").getOrCreate()
...
df.coalesce(1).write.mode('append').csv('s3://staging-near-data-analytics/shashwat/ps-3966/phase_2/primary_school/',header=True)
