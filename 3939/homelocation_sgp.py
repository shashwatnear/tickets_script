...
df = spark.read.parquet('s3://near-data-warehouse/refined/dataPartner=*/year=2024/month=05/day=*/hour=*/country=SGP/*').select(['ifa', 'devLanguage'])
...
result.write.mode("append").parquet("s3://staging-near-data-analytics/shashwat/ps-3939/reports/expats/parquet/")
