...
# poi = poi.filter(col('Province') == 'Ankara')
...
#     year = date.year
#     dest_path = "s3://staging-near-data-analytics/shashwat/ps-3967/poi_footfall/may/ankara/{}/".format(date)
...
df = spark.read.parquet('s3://staging-near-data-analytics/shashwat/ps-3967/poi_footfall/may/ankara/*/*')
...
df.coalesce(1).write.mode('overwrite').csv(f"s3://staging-near-data-analytics/shashwat/ps-3967/bayer_may/ankara/", header = True)
