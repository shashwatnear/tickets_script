...
dag = DAG('hkg_inbound_monthly', 
          default_args=default_args,
          schedule_interval='0 12 22 * *', 
          max_active_runs=1, 
          catchup=False)
...
t1 = SparkSubmitOperator(
       task_id = 'monthly_refresh_tourists_data_hongkong',
       conn_id = spark_conn_id,
       name = 'monthly_refresh_tourists_data_hongkong',
       application = '/opt/airflow/scripts/shashwat/monthly_refresh_tourists_data_hongkong.py',
       application_args = [
