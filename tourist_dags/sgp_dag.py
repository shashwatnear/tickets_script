...
t1 = SparkSubmitOperator(
       task_id = 'monthly_refresh_tourists_data_singapore',
       conn_id = spark_conn_id,
       name = 'monthly_refresh_tourists_data_singapore',
       application = '/opt/airflow/scripts/shashwat/monthly_refresh_tourists_data_singapore.py',
       application_args = [
