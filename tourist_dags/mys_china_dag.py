...
dag = DAG('mys_china_inbound_monthly', 
...
t1 = SparkSubmitOperator(
       task_id = 'mys_china_inbound_monthly',
       conn_id = spark_conn_id,
       name = 'mys_china_inbound_monthly',
       application = '/opt/airflow/scripts/shashwat/mys_china_inbound_monthly.py',
       application_args = [
