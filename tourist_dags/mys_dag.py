...
t1 = SparkSubmitOperator(
       task_id = 'monthly_refresh_tourists_data_malaysia',
       conn_id = spark_conn_id,
       name = 'monthly_refresh_tourists_data_malaysia',
       application = '/opt/airflow/scripts/shashwat/monthly_refresh_tourists_data_malaysia.py',
       application_args = [
