...
t1 = SparkSubmitOperator(
       task_id = 'monthly_refresh_tourists_data_australia',
       conn_id = spark_conn_id,
       name = 'monthly_refresh_tourists_data_australia',
       application = '/opt/airflow/scripts/shashwat/monthly_refresh_tourists_data_australia.py',
       application_args = [
