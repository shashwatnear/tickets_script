...
dag = DAG('sgp_china_inbound_monthly', 
...
t1 = SparkSubmitOperator(
       task_id = 'sgp_china_inbound_monthly',
       conn_id = spark_conn_id,
       name = 'sgp_china_inbound_monthly',
       application = '/opt/airflow/scripts/shashwat/sgp_china_inbound_monthly.py',
       application_args = [
