...
t1 = SparkSubmitOperator(
       task_id = 'monthly_refresh_tourists_data_newzealand',
       conn_id = spark_conn_id,
       name = 'monthly_refresh_tourists_data_newzealand',
       application = '/opt/airflow/scripts/shashwat/monthly_refresh_tourists_data_newzealand.py',
       application_args = [
