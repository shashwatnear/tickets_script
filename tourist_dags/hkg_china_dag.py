...
dag = DAG('hkg_china_inbound_monthly', 
...
t1 = SparkSubmitOperator(
       task_id = 'hkg_china_inbound_monthly',
       conn_id = spark_conn_id,
       name = 'hkg_china_inbound_monthly',
       application = '/opt/airflow/scripts/shashwat/hkg_china_inbound_monthly.py',
       application_args = [
